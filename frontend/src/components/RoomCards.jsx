...
const RoomCards = ({ room }) => {
  ...
  return (
    <Link to={`/rooms/${room.id}`}>
      <div className="relative mx-auto w-full min-w-[280px] max-w-sm h-fit transform cursor-pointer overflow-hidden rounded-lg shadow-2xl border group smooth-transition hover:scale-101 py-3 hover:drop-shadow-[0_0_2px_rgba(234,88,12,1)]">
